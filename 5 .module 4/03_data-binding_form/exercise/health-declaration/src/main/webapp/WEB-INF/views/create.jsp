...
<div class="container-fluid">
    <div class="row">
        <div class="col-12 text-center"><h3>TỜ KHAI Y TẾ</h3></div>
    </div>
    <div class="row">
        <div class="col-12 text-center"><h5>ĐÂY LÀ TÀI LIỆU QUAN TRỌNG, THÔNG TIN CỦA ANH/CHỊ SẼ GIÚP CƠ QUAN Y TẾ LIÊN LẠC KHI CẦN
            THIẾT ĐỀ PHONG CHỐNG DỊCH BỆNH TRUYỀN NHIỄM</h5></div>
    </div>
    <div class="row">
        <div class="col-12 text-center"><h6 style="color: red">Khuyến cáo: Khai báo thông tin sai là vi phạm pháp luật Việt Nam và
    ...
    <div class="container-fluid">
        ...
        <div class="row mb-2">
            ...
            <div class="col-4">
                ...
                <form:select path="nationality" cssClass="form-select mt-2">
        ...
        <div class="row mb-2">
            <div class="col-12 text-danger text-center">
                <button type="submit" class="button btn-success bg-gradient rounded-3">Khai báo</button>
            </div>
        </div>
    </div>
</form:form>
