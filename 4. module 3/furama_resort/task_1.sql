...
values('Le Thi Hong','1990-02-10','Female','200912131','0906123456','hong@gmail.com',(select c.id from customer_type c where customer_type_name = 'Gold'),'Đà Nẵng');

insert into customer(`name`,birthday,gender,personal_id,phone_number,email,customer_type_id,address)
values('Tran Van Chau','1995-02-10','Male','200976131','0906654123','chau@gmail.com',(select c.id from customer_type c where customer_type_name = 'Silver'),'Quảng Trị');

insert into customer(`name`,birthday,gender,personal_id,phone_number,email,customer_type_id,address)
values('Ngo Thanh Van','1990-02-10','Female','201819992','0905686564','van@gmail.com',(select c.id from customer_type c where customer_type_name = 'Diamond'),'Vinh');

insert into customer(`name`,birthday,gender,personal_id,phone_number,email,customer_type_id,address)
values('Ngo Kinh','2005-02-15','Male','2018199432','0905686569','ngokinh@gmail.com',(select c.id from customer_type c where customer_type_name = 'Diamond'),'Đà Nẵng');

insert into customer(`name`,birthday,gender,personal_id,phone_number,email,customer_type_id,address)
values('Ngo Kinh','1990-05-10','Male','1994123112','0905987345','ngokinh1990@gmail.com',(select c.id from customer_type c where customer_type_name = 'Platinium'),'Quang Ngai');

insert into customer(`name`,birthday,gender,personal_id,phone_number,email,customer_type_id,address)
values('Chau Dai Phat','1985-05-10','Male','1204123562','0905987654','chaudaiphat@gmail.com',(select c.id from customer_type c where customer_type_name = 'Member'),'Ca Mau');
