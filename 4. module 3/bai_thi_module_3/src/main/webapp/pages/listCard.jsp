                                ...
                                <c:forEach var="card" items="${cardList}">
                                    <tr>
                                        <td class="align-middle p-3 text-center">
                                            <span class="text-secondary text-xs font-weight-bold">${card.getId()}</span>
                                        </td>
                                        <td class="align-middle p-2 text-center">
                                            <span class="text-secondary text-xs font-weight-bold">${card.getBook().getName()}</span>
                                        </td>
                                        <td class="align-middle p-2 text-center">
