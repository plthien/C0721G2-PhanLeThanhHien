                ...
                <div class="card mb-4">
                    ...
                    <form class="row g-3 needs-validation m-3" method="post">
                        ...
                        <div class="col-md-4 position-relative">
                            ...
                            <select class="form-select" name="inputIdFacility" id="validationTooltip01" required>
                                <c:forEach var="facility" items="${facilityList}">
                                    <option value="${facility.getId()}">${facility.getId()} - ${facility.getName()}</option>
                                </c:forEach>
                            </select>
                            <div class="invalid-tooltip">
                                Please select a valid state.
                        ...
                        <div class="col-md-2 position-relative">
                            ...
                            <input type="date" class="form-control" name="inputCheckinDate" id="validationTooltip02" required>
                        </div>
                        <div class="col-md-2 position-relative">
                            <label for="validationTooltip03" class="form-label">Checkout Date</label>
                            <input type="date" class="form-control" name="inputCheckoutDate" id="validationTooltip03" required>
                        </div>
                        <div class="col-md-2 position-relative">
                            <label for="validationTooltip04" class="form-label">Deposit</label>
                            <input type="text" class="form-control" name="inputDeposit" id="validationTooltip04" required>
                        </div>
                        <div class="col-md-2 position-relative">
                            <label for="validationTooltip05" class="form-label">Payment</label>
                            <input type="text" class="form-control" name="inputPayment" id="validationTooltip05" required>
                        </div>
                        <div class="col-md-3 position-relative">
